...
from generator_model import QuantumBlock
from discriminator_model import QuantumBlock
...
def main():
    ...
    disc_D.quantum_block = QuantumBlock(n_qubits=n_qubits, n_layers=n_layers)
    disc_N.quantum_block = QuantumBlock(n_qubits=n_qubits, n_layers=n_layers)
    gen_N.quantum_block = QuantumBlock(n_qubits=n_qubits, n_layers=n_layers)
    gen_D.quantum_block = QuantumBlock(n_qubits=n_qubits, n_layers=n_layers)
